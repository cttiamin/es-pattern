...
function drag(elementToDrag, event) {
  ...
  //    console.log(scroll.x + " client:"+event.clientX);
  var startX = event.clientX + scroll.x; //equal to event.pageX
  ...
  var origX = elementToDrag.offsetLeft; //左边距, at 120_DOM
  ...
  var deltaX = startX - origX; //相对元素内的x坐标
