// ////////////////////
// 当文档准备就绪时调用函数
// 传递函数给 whenReady 当文档解析完且为操作准备就绪时.
// 如果文档没有准备好则加入准备队列
//  17-1 Pass a function to whenReady() and it will be invoked (as a method of the
...
//  immediately.
///
export var whenReady = (function() { // This function returns the whenReady() function
